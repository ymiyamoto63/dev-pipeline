...
Do not edit any code files — {{claude:Write access}}{{copilot:your file-editing capability}} is only for {{claude:the}}{{copilot:writing the}} review report itself. Do not re-explain what the code does — only report actual defects.
